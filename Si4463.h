...
typedef enum
{
	...
	FCtrl_CHANNEL_STEP_SIZE_1    = 0x4004,
	FCtrl_CHANNEL_STEP_SIZE_0	= 0x4005,
...
*/
// GOLBAL(0x00)
#define GLOBAL_XO_TUNE( x )                 Si4463_SET_PROPERTY_1( 0x0000, x )
#define GLOBAL_CLK_CFG( x )                 Si4463_SET_PROPERTY_1( 0x0001, x )
#define GLOBAL_LOW_BATT_THRESH( x )         Si4463_SET_PROPERTY_1( 0x0002, x )
#define GLOBAL_CONFIG( x )                  Si4463_SET_PROPERTY_1( 0x0003, x )
#define GLOBAL_WUT_CONFIG( x )              Si4463_SET_PROPERTY_1( 0x0004, x )
#define GLOBAL_WUT_M_15_8( x )              Si4463_SET_PROPERTY_1( 0x0005, x )
#define GLOBAL_WUT_M_7_0( x )               Si4463_SET_PROPERTY_1( 0x0006, x )
#define GLOBAL_WUT_R( x )                   Si4463_SET_PROPERTY_1( 0x0007, x )
#define GLOBAL_WUT_LDC( x )                 Si4463_SET_PROPERTY_1( 0x0008, x )
#define GLOBAL_WUT_CAL( x )                 Si4463_SET_PROPERTY_1( 0x0009, x )

// INT_CTL(0x01)
#define INT_CTL_ENABLE( x )                 Si4463_SET_PROPERTY_1( 0x0100, x )
#define INT_CTL_PH_ENABLE( x )              Si4463_SET_PROPERTY_1( 0x0101, x )
#define INT_CTL_MODEM_ENABLE( x )           Si4463_SET_PROPERTY_1( 0x0102, x )
#define INT_CTL_CHIP_ENABLE( x )            Si4463_SET_PROPERTY_1( 0x0103, x )

//group 0x02, FRR_CTL
#define FRR_CTL_A_MODE( x )                 Si4463_SET_PROPERTY_1( 0x0200, x )
#define FRR_CTL_B_MODE( x )                 Si4463_SET_PROPERTY_1( 0x0201, x )
#define FRR_CTL_C_MODE( x )                 Si4463_SET_PROPERTY_1( 0x0202, x )
#define FRR_CTL_D_MODE( x )                 Si4463_SET_PROPERTY_1( 0x0203, x )

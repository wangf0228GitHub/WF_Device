...
#define wfEEPROM_WriteByte(Addr,x) HAL_FLASHEx_DATAEEPROM_Unlock();HAL_FLASHEx_DATAEEPROM_Program(FLASH_TYPEPROGRAMDATA_BYTE,wfEEPROM_BASE_ADDR + Addr,x);HAL_FLASHEx_DATAEEPROM_Lock()
#define wfEEPROM_WriteHalfWord(Addr,x) HAL_FLASHEx_DATAEEPROM_Unlock();HAL_FLASHEx_DATAEEPROM_Program(FLASH_TYPEPROGRAMDATA_HALFWORD,wfEEPROM_BASE_ADDR + Addr,x);HAL_FLASHEx_DATAEEPROM_Lock()
